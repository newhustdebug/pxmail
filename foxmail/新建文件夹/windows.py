...
# Form implementation generated from reading ui file 'C:\Users\h\Desktop\foxmail\ui\mainwindow1.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.iconlabel.setPixmap(QtGui.QPixmap("logo.png"))
        ...
        self.labelmin_2 = QtWidgets.QLabel(self.widget_2)
        self.labelmin_2.setMinimumSize(QtCore.QSize(30, 30))
        self.labelmin_2.setMaximumSize(QtCore.QSize(30, 30))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        self.labelmin_2.setFont(font)
        self.labelmin_2.setStyleSheet("QLabel{\n"
"   color:white;\n"
"    border:0px;\n"
"}\n"
"QLabel:hover{\n"
...
"}")
        ...
        self.labelmin_2.setObjectName("labelmin_2")
        self.horizontalLayout_10.addWidget(self.labelmin_2)
...
"*/")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("1refresh_128px_1194515_easyicon.net.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("1point_list_128px_1190662_easyicon.net.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("Receiving_in_mail_128px_1200029_easyicon.net.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        item_0.setFont(0, font)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("draft_128px_1150028_easyicon.net.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        item_0.setFont(0, font)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("sent_2133px_1152650_easyicon.net.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        item_0.setFont(0, font)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("garbage_118px_1201094_easyicon.net.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.btnReply.setMinimumSize(QtCore.QSize(170, 26))
        self.btnReply.setFocusPolicy(QtCore.Qt.NoFocus)
        self.btnReply.setStyleSheet("")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("reply.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.btnForward.setMinimumSize(QtCore.QSize(171, 26))
        self.btnForward.setFocusPolicy(QtCore.Qt.NoFocus)
        self.btnForward.setStyleSheet("")
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("forward.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.btnDelete.setMinimumSize(QtCore.QSize(170, 26))
...
"")
        ...
        self.actionCompose.setIcon(icon1)
        ...
        self.actionContactList.setIcon(icon3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p align=center><span  style=\" font-size:11pt; font-weight:600; color:#ffffff;\">Pxmail</span></p></body></html>"))
        self.labelmin_2.setText(_translate("MainWindow", "一"))
        self.labelmin.setText(_translate("MainWindow", "口"))
        ...
        self.treeMailWidget.topLevelItem(3).setText(0, _translate("MainWindow", "垃圾邮件"))
